...
extension Notification.Name {
    ...
    static let dataSavingError = Notification.Name("Error Saving Data")
    static let dataLoadingError = Notification.Name("Error Loading Data")
...
class AppDelegate: UIResponder, UIApplicationDelegate, CAAnimationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        container.loadPersistentStores(completionHandler: { (storeDescription, error) in
            if let error = error {
                NotificationCenter.default.post(name: .dataLoadingError, object: error)
            }
        })
        return container
    }()
    ...
    func saveContext () {
        ...
        if context.hasChanges {
            do {
                ...
                NotificationCenter.default.post(name: .dataSavingError, object: error)
            }
        }
    }
